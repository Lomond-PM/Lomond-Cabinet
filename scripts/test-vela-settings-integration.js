...
function run() {
    ...
    check(/experimentalEnabled:\s*false/.test(mainSource) && /checkProviderReadiness/.test(mainSource), "Production bootstrap remains disabled and performs readiness only through the Runtime facade after explicit opt-in.");
