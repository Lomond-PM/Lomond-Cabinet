...
async function run() {
    ...
    check(logicalStep1.state === "awaiting-review" && logicalStep1.logicalPlan.currentStepIndex === 1 && logicalStep1.logicalPlan.completedStepCount === 1 && logicalStep1.suspendedReview.capabilityId === "set-layer-name-v1" && logicalHappy.state.value === 47, "Verified step 0 performs fresh Observe and independently materializes rename Review.");
