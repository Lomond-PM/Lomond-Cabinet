...
assert.ok(/developer\.body\.appendChild\(createSettingsDesignTuningSection\(\)\)[\s\S]*settingsDeveloperProceduralMount/.test(main), "Design Tuning is one consolidated first entry in Developer");
assert.ok(/function createSettingsDesignTuningSection[\s\S]*settingsDeveloperDesignTuningMount[\s\S]*settingsDeveloperCalibrationMount/.test(main), "Design Tuning section owns the tuning and calibration row sets together");
