...
check(!/provider-review|provider-approve|createOpacityCandidate|approveCandidate|rejectCandidate/.test(source), "Provider UI exposes no proposal promotion, confirmation or execution control.");
