...
assert(declaration("--type-field-label-size", "calc\\(12px \\* var\\(--appearance-type-field-label-scale\\) \\* var\\(--ui-scale\\)\\)"));
assert(declaration("--type-supporting-size", "calc\\(10\\.5px \\* var\\(--appearance-type-supporting-scale\\) \\* var\\(--ui-scale\\)\\)"));
assert(declaration("--type-section-title-size", "calc\\(14px \\* var\\(--appearance-type-section-title-scale\\) \\* var\\(--ui-scale\\)\\)"));
assert(declaration("--type-code-size", "calc\\(10\\.5px \\* var\\(--appearance-type-code-scale\\) \\* var\\(--ui-scale\\)\\)"));
