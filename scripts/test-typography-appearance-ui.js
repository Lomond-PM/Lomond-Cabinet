...
assert(/parameter\.category === "surfaces" \|\| parameter\.category === "text"/.test(main), "Interface Appearance routes surfaces/text params");
assert(/createAppearanceDisclosureSection\(?[\s\S]*settings\.appearance\.advanced\.title/.test(main), "Advanced Appearance Settings is a CoreUI disclosure");
assert(/parameter\.category === "typography"/.test(main), "Typography params route into Advanced Appearance Settings");
