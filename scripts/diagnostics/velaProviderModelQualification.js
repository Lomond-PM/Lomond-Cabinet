...
module.exports = Object.freeze({ ENDPOINT, DEFAULT_TIMEOUT_MS, REPOSITORY_ROOT, OUTPUT_ROOT, EXECUTION_STATUSES, ASSESSMENT_STATUSES, FIXTURES, CASES, createProtocol, contextText, parseArgs, hasAbsolutePathForm, outputPolicy, assertOutputPath, qualificationMetadata, BRANCH_POLICY_REVISION, isUnavailableExplanation, containsCurrentOpacityGuess, isCorrectUnavailableText, evaluateIntentGate, classify, recordedResult, reclassifyEvidence, summarize, createRunStatus, reportMarkdown, byteLength, transportModule, providerAdapterModule, capabilityContracts });
