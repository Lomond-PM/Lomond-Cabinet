...
const RUBRIC_PATH = path.join(__dirname, "..", "fixtures", "vela-provider-profile-qualification", "acceptance-rubric-c4-v2.json");
...
function validateRubric(rubric) {
    ...
    return rubric.fixtureType === "vela-provider-profile-qualification-acceptance-rubric" && rubric.revision === "vela-provider-profile-qualification-rubric-c4-v2" && rubric.generatedBy === "0.3.4-B prompt-contract successor; thresholds preserved from C4-C2R" && validateRunRubric(rubric.pilot5Run, frozen.pilot5Run) && validateRunRubric(rubric.final20Run, frozen.final20Run) && same(rubric, frozen);
}
