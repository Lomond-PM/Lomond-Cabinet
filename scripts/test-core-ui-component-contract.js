...
var factories = ["createTextInput", "createTextarea", "createNumberInput", "createRangeNumber", "createSelect", "createSwitch", "createColorField", "createButton", "createFieldRow"];
...
["ui-text-input", "ui-textarea", "ui-number-input", "ui-range-number", "ui-select", "ui-switch", "ui-color-field", "ui-button", "ui-field-row"].forEach(function (name) {
