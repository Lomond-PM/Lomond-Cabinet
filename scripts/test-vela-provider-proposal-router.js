...
async function run() {
    ...
    check(greetingState.state === "completed" && greetingState.text.includes("localProposal") && greetingState.proposalCapabilityId === null && greetingState.suggestedOpacity === null && greeting.provider.getUiState().state !== "proposal-ready", "A plain greeting receiving localProposal remains inert assistant prose before Intent Gate and leaves no proposal for the Router to review.");
