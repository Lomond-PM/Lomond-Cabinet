...
ok(!store.setOverride("surface.card", "#121212"), "retired test-only Card Surface override is rejected");
...
store.save();
equal(JSON.parse(storage.values[StoreModule.storageKey]), { version: 1, overrides: { "surface.panel": "#10100d" } }, "persistence drops retired and unknown authorities");
