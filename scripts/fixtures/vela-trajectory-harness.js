...
function loader(ref, observer) {
    ...
    function load(name) {
        ...
        m.require = function (request) { return request.startsWith("./") ? load(request.slice(2)) : require(request); };
        ...
        m._compile(source, filename); m.loaded = true;
