...
// Production integration boundaries remain explicit and idempotent.
{
    ...
    check(/toolCatalog\.getHomeEntries\(\{ developerMode:/.test(main) && !/openEcommerceLayoutTool|registerStaticHomeEntry\(["']ecommerceLayout["']/.test(main + html), "ecommerceLayout is rendered only by the dynamic Tool Catalog projection");
