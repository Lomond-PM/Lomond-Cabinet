(function (root, factory) {
    ...
    function create(options) {
        ...
        function refreshLocale() { review.textContent = t("vela.surfaceReview"); approve.textContent = t("vela.surfaceApprove"); reject.textContent = t("vela.surfaceReject"); }
        ...
        review.addEventListener("click", function () { if (!disposed && !review.disabled) { onReview(); } });
        approve.addEventListener("click", function () { if (!disposed && !approve.disabled) { onApprove(); } });
        reject.addEventListener("click", function () { if (!disposed && !reject.disabled) { onReject(); } });
        ...
        return Object.freeze({ render: render, refreshLocale: refreshLocale, dispose: function () { disposed = true; }, getElementsForTest: function () { return { summary: summary, review: review, approve: approve, reject: reject }; } });
    }
