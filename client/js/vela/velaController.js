    ...
    function createController(options) {
        ...
        function safeState() {
            return protocol.deepFreeze({
                ...
                reviewTarget: activeRecord ? activeRecord.reviewTarget || null : null,
                reviewRevision: activeRecord && Number.isInteger(activeRecord.reviewRevision) ? activeRecord.reviewRevision : null,
        ...
        function createBoundOpacityCandidate(input) {
            ...
            return preflight.createBoundPlan({
                ...
                activeRecord = {
                    ...
                    reviewTarget: plan.reviewTarget ? { compId: plan.reviewTarget.compId, layerId: plan.reviewTarget.layerId } : null,
                    reviewRevision: plan.planRevision,
