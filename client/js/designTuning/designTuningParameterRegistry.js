(function (root, factory) {
    ...
    var definitions = [
        ...
        { id: "spacing.content.inlineInset", type: "lengthPx", domain: "spacing", group: "content", cssProperty: "--space-content-inline-inset", validity: { min: 0 }, editing: { trackMin: 2, trackMax: 20, step: 1, unit: "px" } },
        { id: "spacing.content.blockInset", type: "lengthPx", domain: "spacing", group: "content", cssProperty: "--space-content-block-inset", validity: { min: 0 }, editing: { trackMin: 2, trackMax: 20, step: 1, unit: "px" }, presentation: { labelKey: "settings.designTuning.parameter.spacing.content.blockInset", descriptionKey: "settings.designTuning.parameter.spacing.content.blockInset.description" } },
