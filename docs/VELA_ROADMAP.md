...
| 0.3.11 — Multi-conversation Foundation | IN PROGRESS; A1 Conversation Ownership Root COMPLETE / SEALED; 177/177 offline PASS and 5/5 targeted real-AE PASS; production still one conversation; A2 Conversation-owned Presentation + F1 offline 179/179 PASS, real-AE PASS / COMPLETE / SEALED (Case 6 re-test; recorded limitation); A3 COMPLETE / SEALED, 180/180 offline and six real-AE cases PASS; architecture amendment NONE |
