...
| 0.3.10 — Context Architecture | IN PROGRESS; A0/A1/A2 and A3a/A3b complete; A4a execution/Verify evidence audit and projection contract complete; A4b implementation and A5–A6 not started |
...
[A4a source/projection contract](design/vela-verified-trajectory-0.3.10-a4a.md) now defines orthogonal execution/commit/Verify/completion evidence, explicit unknowns, partial-completion preservation and a bounded in-memory owner/lifecycle decision. A4b will implement read-only reporting from canonical sources without execution, Verify or Session schema changes. A4 answers what evidence exists; A5 alone decides future Provider selection. No trajectory implementation or history injection ships in A4a.
