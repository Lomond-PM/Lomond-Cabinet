...
| 0.3.10 — Context Architecture | IN PROGRESS; A0/A1/A2 and A3a/A3b complete; A4a execution/Verify evidence audit and projection contract complete; A4b implemented / offline integration PASS / real AE acceptance pending; A5–A6 not started |
...
[A4a source/projection contract](design/vela-verified-trajectory-0.3.10-a4a.md) defines orthogonal execution/commit/Verify/completion evidence, explicit unknowns, partial-completion preservation and bounded in-memory ownership. [A4b implementation evidence](reports/vela-0.3.10-a4b-verified-trajectory.md) records read-only canonical-source reporting with 34 focused offline suites / 4,022 assertions PASS. Six targeted real AE projection cases remain pending, so A4b is not closed. Execution, Verify, Session and Provider semantics remain unchanged. A4 answers what evidence exists; A5 alone decides future Provider selection.
