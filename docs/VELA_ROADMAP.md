...
Status: current roadmap; reconciled at 0.3.11 Multi-conversation Foundation COMPLETE / SEALED. Next0.3.12 Capability Model Generalization is NOT STARTED.
...
| 0.3.11 — Multi-conversation Foundation | COMPLETE / SEALED; A1 Conversation Ownership Root COMPLETE / SEALED; 177/177 offline PASS and 5/5 targeted real-AE PASS; default startup still seeds one conversation; A2 Conversation-owned Presentation + F1 offline 179/179 PASS, real-AE PASS / COMPLETE / SEALED (Case 6 re-test; recorded limitation); A3 COMPLETE / SEALED, 180/180 offline and six real-AE cases PASS; A4 COMPLETE / SEALED, 181/181 offline, 89 focused assertions, 93/93 in each Vela order, eight bounded real-CEP cases and default UI smoke PASS; A5 COMPLETE / SEALED, 182/182 offline, 94/94 each order, 11 actual-product CEP/AE cases PASS; final integrated acceptance PASS with retained evidence boundaries, formal milestone seal complete; architecture amendment NONE |
| 0.3.12 — Capability Model Generalization | NOT STARTED; next feature dependency |
...
0.3.11 owns Multi-conversation Foundation. [A2 presentation report](reports/vela-0.3.11-a2-conversation-presentation.md) records the conversation-owned PresentationModel and explicit Surface injection; A2 and F1 are COMPLETE / SEALED after targeted real-AE re-acceptance, with the first Case 6 response-field UNKNOWN retained in the seal. **0.3.11-A3 — Source-bound Async & Command Routing** is COMPLETE / SEALED: 180/180 offline PASS, 54 focused assertions PASS, six real-AE DevTools cases PASS; [routing report](reports/vela-0.3.11-a3-source-routing.md). Formal A3 seal completed 2026-09-07. **0.3.11-A4 — Multi-record Runtime Composition** is **COMPLETE / SEALED**: 181/181 offline, 89 focused assertions, 93/93 in each Vela order, eight bounded real-CEP cases and final default UI smoke PASS; [A4 report](reports/vela-0.3.11-a4-runtime-composition.md). Production supports multiple live records with global single-active-objective admission; default startup selects one. Formal A4 documentation seal completed 2026-09-07. **0.3.11-A5 — Minimal Conversation Selection Surface** is **COMPLETE / SEALED** (formal documentation seal 2026-09-07): 66 focused assertions, 182/182 full offline suites, 94/94 in each Vela order and 11 targeted actual-product CEP/AE cases PASS. See [A5 report](reports/vela-0.3.11-a5-conversation-selection.md) for the bounded evidence and retained UNKNOWNs. Overall 0.3.11: **COMPLETE / SEALED**. See [final integrated acceptance](reports/vela-0.3.11-integrated-acceptance.md): continuous real-product scenarios passed with explicit inherited offline subchecks and UNKNOWNs; no production/test edits, sealed 182/182 and 94/94 ×3 reused. Formal milestone seal reconciliation is complete with all evidence limitations preserved. Exact next feature dependency: **0.3.12 — Capability Model Generalization: NOT STARTED**. The A3 seal retains all evidence limitations in the report: offline-only C1/C2 isolation, injected production-handler lifecycle replacement, manually transcribed real-AE evidence, inherited UNKNOWNs and the safely blocked cleanup mismatch with uncaptured numeric output. The explicit retry restored opacity 100 through fresh Verify. In current 0.3.10, reasoning is retained only for the current turn/objective; a new objective clears old raw reasoning. Cross-turn reasoning presentation/history is deferred to conversation/history architecture. Whether UI history retains reasoning and whether model context consumes it are separate decisions; the former does not imply the latter.
