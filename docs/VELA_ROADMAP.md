...
| 0.3.10 — Context Architecture | IN PROGRESS; A0/A1/A2 complete; A3a policy recorded; A3b pure normalization/conditional disposition implemented and focused offline validated; A4–A6 not started |
