...
| button.randomize | button | Randomize | 随机 | .tmp/a08-f1b/start/scripts/report-i18n-usage.js, client/js/settingsSchema.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| button.refreshSelection | button | Refresh Selection | 刷新选择 | .tmp/a08-f1b/start/scripts/report-i18n-usage.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
...
| common.close | common | Close | 关闭 | .tmp/a08-f1b/start/scripts/test-vela-settings-integration.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
...
| core.bezier.speedInfluenceHint | core | Shift + horizontal drag: influence only | Shift + 水平拖动：仅调整影响范围 | .tmp/a08-f1b/start/scripts/test-core-ui-component-contract.js, client/js/main.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| helper.homeBaseColor | helper | Sets the underlying base color of the Home surface; it does not defin... | 设置主页表面的底层基底色，不代表完整背景处理。 | .tmp/a08-f1b/start/scripts/test-registry-tool-schema-i18n.js, client/js/settingsSchema.js, host/tools/settingsRendererLab.tool.jsx | no | E | Deferred. Generic/dynamic key group; needs runtime and AE fallback verification. |
...
| helper.proceduralIconMode | helper | Colorful mode uses each tool's assigned palette. Theme-mapped mode ma... | 彩色模式使用每个工具的分配色卡。主题映射模式按生成图像明度在底色和重点色之间映射。 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js, client/js/settingsSchema.js | no | E | Deferred. Generic/dynamic key group; needs runtime and AE fallback verification. |
| helper.proceduralIconModeColorful | helper | Uses each tool's assigned palette as its final color appearance. | 使用每个工具分配的色卡作为最终颜色外观。 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js, client/js/settingsSchema.js | no | E | Deferred. Generic/dynamic key group; needs runtime and AE fallback verification. |
| helper.proceduralIconModeThemeMapped | helper | Preserves the generated texture and remaps its luminance between two ... | 保留生成纹理，并将其明度映射到两种主题颜色之间。 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js, client/js/settingsSchema.js | no | E | Deferred. Generic/dynamic key group; needs runtime and AE fallback verification. |
| helper.proceduralIconSource | helper | Source palettes still define each tool's generated texture and lumina... | 源色卡仍决定各工具的生成纹理和明度结构。主题映射只替换最终色相，不改变程序化身份。 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js, client/js/settingsSchema.js | no | E | Deferred. Generic/dynamic key group; needs runtime and AE fallback verification. |
...
| helper.sourcePalette | helper | The resolved palette base color becomes the Theme-mapped dark endpoint. | 选中色卡的主体色将成为主题映射暗端。 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js, client/js/settingsSchema.js | no | E | Deferred. Generic/dynamic key group; needs runtime and AE fallback verification. |
...
| label.homeBaseColor | label | Home Base Color | 主页基底色 | .tmp/a08-f1b/start/scripts/test-registry-tool-schema-i18n.js, .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js, client/js/settingsSchema.js, host/tools/settingsRendererLab.tool.jsx | no | E | Deferred. Generic/dynamic key group; needs runtime and AE fallback verification. |
...
| label.iconDarkSource | label | Icon Dark Source | 图标暗端来源 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js, client/js/settingsSchema.js | no | E | Deferred. Generic/dynamic key group; needs runtime and AE fallback verification. |
...
| label.proceduralIconMode | label | Icon Color Mode | 图标配色模式 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js, client/js/settingsSchema.js | no | E | Deferred. Generic/dynamic key group; needs runtime and AE fallback verification. |
...
| label.sourcePalette | label | Source Palette | 源色卡 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js, client/js/settingsSchema.js | no | E | Deferred. Generic/dynamic key group; needs runtime and AE fallback verification. |
...
| settings.designTuning.promotionEvidence | settings | Promotion Evidence | 采纳依据 | .tmp/a08-f1b/start/scripts/test-global-status-i18n.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
...
| settings.iconDarkSource.manualEndpoints | settings | Manual Endpoints | 手动端点 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js, client/js/settingsSchema.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| settings.iconDarkSource.paletteScale | settings | Palette Scale | 色卡明度缩放 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js, client/js/settingsSchema.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
...
| settings.palette.manage | settings | Manage Palettes | 管理色卡 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| settings.palette.manageSource | settings | Manage Source Palettes | 管理源色卡 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
...
| settings.paletteLibrary | settings | Palette Library | 色卡库 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
...
| settings.sections.vela | settings | Vela | Vela | .tmp/a08-f1b/start/scripts/test-vela-settings-integration.js, client/js/settingsSchema.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
...
| settings.theme.fallbackIconColors | settings | Fallback Icon Colors | 回退图标颜色 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
...
| settings.theme.interfaceAppearance | settings | Interface Appearance | 界面外观 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| settings.theme.lightEndpoint | settings | Light | 亮端 | client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| settings.theme.midEndpoint | settings | Mid | 中间调 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| settings.theme.toolIconAppearance | settings | Tool Icon Appearance | 工具图标外观 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js, client/js/settingsSchema.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| settings.vela.acknowledgement | settings | I understand this Provider is experimental and not qualified | 我理解此 Provider 为实验性且未通过资格认证 | .tmp/a08-f1b/start/scripts/test-vela-settings-integration.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
...
| settings.vela.disableSession | settings | Disable | 禁用 | .tmp/a08-f1b/start/scripts/test-vela-settings-integration.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
...
| settings.vela.enableSession | settings | Enable for this session | 本会话启用 | .tmp/a08-f1b/start/scripts/test-vela-settings-integration.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| settings.vela.endpoint | settings | Local endpoint | 本地 endpoint | .tmp/a08-f1b/start/scripts/test-vela-settings-integration.js, client/js/main.js, client/js/settingsSchema.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| settings.vela.endpointDescription | settings | Loopback LM Studio endpoint only (127.0.0.1, localhost, or ::1). | 仅允许 loopback LM Studio endpoint（127.0.0.1、localhost 或 ::1）。 | .tmp/a08-f1b/start/scripts/test-vela-settings-integration.js, client/js/settingsSchema.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| settings.vela.endpointInvalid | settings | The endpoint must be a loopback LM Studio base URL | endpoint 必须是 loopback LM Studio base URL | .tmp/a08-f1b/start/scripts/test-vela-settings-integration.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| settings.vela.experimentalDescription | settings | Experimental · Not qualified · Manual opt-in required. Session enable... | 实验性 · 未通过资格认证 · 需手动选择加入。会话启用状态不会保存。 | .tmp/a08-f1b/start/scripts/test-vela-settings-integration.js, client/js/settingsSchema.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
...
| settings.vela.httpFailed | settings | LM Studio readiness returned an unsuccessful response | LM Studio readiness 返回了不成功的响应 | .tmp/a08-f1b/start/scripts/test-vela-settings-integration.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| settings.vela.model | settings | Model name | 模型名称 | .tmp/a08-f1b/start/scripts/test-vela-settings-integration.js, client/js/main.js, client/js/settingsSchema.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| settings.vela.modelDescription | settings | Use the exact model identifier currently loaded or exposed by LM Studio. | 请使用与 LM Studio 当前已加载或已暴露的模型标识完全一致的名称。 | .tmp/a08-f1b/start/scripts/test-vela-settings-integration.js, client/js/settingsSchema.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| settings.vela.modelNotFound | settings | The configured model was not found | 未找到配置的模型 | .tmp/a08-f1b/start/scripts/test-vela-settings-integration.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| settings.vela.modelNotLoaded | settings | The configured model is installed but not loaded | 配置的模型已安装但未加载 | .tmp/a08-f1b/start/scripts/test-vela-settings-integration.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| settings.vela.networkFailed | settings | Cannot reach the local LM Studio server | 无法连接本地 LM Studio 服务器 | .tmp/a08-f1b/start/scripts/test-vela-settings-integration.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
...
| settings.vela.responseInvalid | settings | LM Studio returned an invalid readiness response | LM Studio 返回了无效 readiness 响应 | .tmp/a08-f1b/start/scripts/test-vela-settings-integration.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| settings.vela.title | settings | Vela Settings | Vela 设置 | .tmp/a08-f1b/start/scripts/test-vela-settings-integration.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
...
| status.backgroundDefaultsRestored | status | Background defaults restored. | 背景已恢复默认。 | .tmp/a08-f1b/start/scripts/report-i18n-usage.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| status.backgroundRandomized | status | Background randomized. | 背景已随机。 | .tmp/a08-f1b/start/scripts/report-i18n-usage.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| status.colorPickerOpening | status | Opening AE color picker... | 正在打开 AE 取色器... | .tmp/a08-f1b/start/scripts/report-i18n-usage.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| status.colorUnchanged | status | Color unchanged. | 颜色未改变。 | .tmp/a08-f1b/start/scripts/report-i18n-usage.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| status.colorUpdated | status | Color updated. | 颜色已更新。 | .tmp/a08-f1b/start/scripts/report-i18n-usage.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
...
| status.homeEditing | status | Home editing. Drag tools to reorder. | 主页编辑中。拖动工具可重排。 | .tmp/a08-f1b/start/scripts/report-i18n-usage.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| status.homeLayoutSaved | status | Home layout saved. | 主页布局已保存。 | .tmp/a08-f1b/start/scripts/report-i18n-usage.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| status.hostLoadError | status | Error: host JSX did not load. Check host/index.jsx includes. | 错误：host JSX 未加载。请检查 host/index.jsx include。 | .tmp/a08-f1b/start/scripts/report-i18n-usage.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
...
| status.loadingHost | status | Loading host JSX... | 正在加载 host JSX... | .tmp/a08-f1b/start/scripts/report-i18n-usage.js, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| status.motionSpeedUpdated | status | Motion speed updated. | 动画速度已更新。 | .tmp/a08-f1b/start/scripts/report-i18n-usage.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| status.multipleLayersSelected | status | {count} layers selected | 已选择 {count} 个图层 | .tmp/a08-f1b/start/scripts/test-global-status-i18n.js, client/js/main.js | no | E | Deferred. Generic/dynamic key group; needs runtime and AE fallback verification. |
...
| status.oneLayerSelected | status | 1 layer selected | 已选择 1 个图层 | .tmp/a08-f1b/start/scripts/test-global-status-i18n.js, client/js/main.js | no | E | Deferred. Generic/dynamic key group; needs runtime and AE fallback verification. |
...
| status.paletteAccentSuggested | status | Palette secondary color applied to Interface Accent; it can be adjust... | 已将色卡辅色设为界面强调色，之后可独立调整。 | .tmp/a08-f1b/start/scripts/test-theme-settings-integration.js, client/js/main.js | no | E | Deferred. Generic/dynamic key group; needs runtime and AE fallback verification. |
...
| status.ready | status | Ready | 就绪 | .tmp/a08-f1b/start/scripts/report-i18n-usage.js, client/index.html, client/js/main.js | no | A | Keep in client/js/i18n.js as core/global UI copy. |
...
| tools.moreTools.title | tools.moreTools | More Tools | 更多工具 | .tmp/a08-f1b/start/scripts/report-i18n-usage.js, client/index.html | no | A | Keep in client/js/i18n.js as core/global UI copy. |
| tools.quickStack.title | tools.quickStack | Quick Stack | 快速堆叠 | .tmp/a08-f1b/start/scripts/report-i18n-usage.js | no | E | Reserved or unused Home label. Confirm no planned implementation before deleting. |
...
| vela.conversationLabel | vela | Conversation {n} | 对话 {n} | .tmp/a08-f1b/start/scripts/test-vela-conversation-switcher.js, client/js/vela/velaConversationSwitcher.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.conversationOtherRunning | vela | Another conversation is running | 另一对话正在运行 | .tmp/a08-f1b/start/scripts/test-vela-conversation-switcher.js, client/js/vela/velaSurfaceController.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.conversationRunning | vela | Running | 运行中 | .tmp/a08-f1b/start/scripts/test-vela-conversation-switcher.js, client/js/vela/velaConversationSwitcher.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceApprove | vela | Approve | 批准 | .tmp/a08-f1b/start/scripts/test-vela-conversation-presentation.js, .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaConfirmationView.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceAuthorityStatus.failed | vela | The authorized change failed; the one-time permission was used | 已授权修改失败，本次权限已使用 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceCancel | vela | Cancel | 取消 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaComposerView.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceComposerLabel | vela | Vela message | Vela 消息 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaComposerView.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceConfirmationLayerName | vela | Layer name: {before} → {proposed} | 图层名称：{before} → {proposed} | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaConfirmationView.js, client/js/vela/velaPresentationModel.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceConfirmationLayerNameReady | vela | A local layer rename is ready for confirmation. | 一个本地图层重命名已准备待确认。 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaPresentationModel.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceConfirmationReady | vela | A local opacity change is ready for confirmation. | 一个本地不透明度更改已准备待确认。 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, .tmp/a08-f1b/start/scripts/test-vela-transcript-scroll.js, client/js/vela/velaPresentationModel.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceConfirmationRejected | vela | The local action suggestion was rejected. No change was made. | 已拒绝本地操作建议。未发生更改。 | .tmp/a08-f1b/start/scripts/test-vela-provider-production-e2e.js, .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaPresentationModel.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceConfirmationValue | vela | Opacity {before}% → {proposed}% | 不透明度 {before}% → {proposed}% | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaConfirmationView.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceContextUnavailable | vela | Unable to read the available After Effects context. Open a compositio... | 无法读取可用的 AE 上下文。请打开合成并选中至少一个图层后重试。 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaPresentationModel.js, client/js/vela/velaSurfaceController.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceExecutionCompleted | vela | The local opacity change was completed. | 本地不透明度更改已完成。 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaPresentationModel.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceExperimentalStatus | vela | Experimental · Not qualified · Manual opt-in required | 实验性 · 未通过资格认证 · 需手动选择加入 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, .tmp/a08-f1b/start/scripts/test-vela-surface.js, client/js/vela/velaSurface.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceGenericError | vela | The local request could not be completed. Try again. | 本地请求未能完成。请重试。 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaPresentationModel.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceGrantOpacityConsent | vela | Allow the next opacity change (once, 60 seconds) | 允许下一次不透明度修改（一次，60 秒） | .tmp/a08-f1b/start/scripts/test-vela-authority-production-composition.js, .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaSurfaceController.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceIntentRejected | vela | No explicit opacity edit was detected. Specify the target opacity for... | 未检测到明确的不透明度修改请求。请说明要将当前图层的不透明度设为多少（0–100%）。 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaPresentationModel.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceIntentTargetMismatch | vela | The local proposal did not match the opacity requested in this turn. ... | 本地 proposal 与本轮请求的不透明度不一致。未创建任何操作。 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaPresentationModel.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceLocalProposalNotice | vela | A local action suggestion was received. This conversation area does n... | 已收到一个本地操作建议。 当前对话区域暂不支持查看或执行该建议。 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaPresentationModel.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceNoActionableTarget | vela | No actionable target is selected. Select a layer in After Effects and... | 当前没有可操作的目标。请在 AE 中选择一个图层后重新发送请求。 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaPresentationModel.js, client/js/vela/velaSurfaceController.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfacePermissionDenied | vela | This action was not authorized and was not performed. | 当前操作未获授权，且未执行。 | client/js/vela/velaPresentationModel.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceProviderConnection | vela | Unable to connect to LM Studio. Start the local server and check it i... | 无法连接 LM Studio。请启动本地服务器并确认其可用后重试。 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaPresentationModel.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceProviderResponse | vela | The local model returned a response that could not be used. Try again. | 本地模型返回了无法使用的响应。请重试。 | .tmp/a08-f1b/start/scripts/test-vela-provider-production-e2e.js, .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaPresentationModel.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceProviderTimeout | vela | The local model took too long to respond. Check LM Studio and try again. | 本地模型响应超时。请检查 LM Studio 后重试。 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaPresentationModel.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceReasoningCancelled | vela | Output stream cancelled | 输出流已取消 | .tmp/a08-f1b/start/scripts/test-vela-transcript-reasoning.js, client/js/vela/velaTranscriptView.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceReasoningCompleted | vela | Output stream ended | 输出流已结束 | .tmp/a08-f1b/start/scripts/test-vela-transcript-reasoning.js, client/js/vela/velaTranscriptView.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceReasoningFailed | vela | Output stream ended with an issue | 输出流结束（出现问题） | .tmp/a08-f1b/start/scripts/test-vela-transcript-reasoning.js, client/js/vela/velaTranscriptView.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceReject | vela | Reject | 拒绝 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaConfirmationView.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceReview | vela | Review | 查看 | .tmp/a08-f1b/start/scripts/test-vela-provider-production-e2e.js, .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaConfirmationView.js, client/js/vela/velaPresentationModel.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceReviewRequired | vela | This action requires authorization before it can run. Allow the next ... | 当前操作需要授权后才能执行。请允许下一次不透明度修改，然后发起新请求。 | .tmp/a08-f1b/start/scripts/test-vela-provider-production-e2e.js, .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaPresentationModel.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceRevokeOpacityConsent | vela | Revoke automatic opacity change | 撤销自动修改不透明度的权限 | .tmp/a08-f1b/start/scripts/test-vela-authority-production-composition.js, .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaSurfaceController.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceSend | vela | Send | 发送 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaComposerView.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceStatusAwaitingContinuation | vela | Approved, awaiting continuation | 已批准，等待继续处理 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaSurfaceController.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceStatusBlocked | vela | Local action requires authorization | 本地操作需要授权 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaSurfaceController.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceStatusConfirmation | vela | Confirm local opacity change | 请确认本地不透明度更改 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaSurfaceController.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceStatusContextStale | vela | Context changed. Start the action again | 上下文已变化，请重新操作 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaSurfaceController.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceStatusExperimentalDisabled | vela | Experimental Provider disabled | 实验 Provider 已禁用 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaSurfaceController.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceStatusFailed | vela | Local request failed | 本地请求失败 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaSurfaceController.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceStatusLayerNameConfirmation | vela | Confirm local layer rename | 请确认本地图层重命名 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaSurfaceController.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceStatusPending | vela | Waiting for local model | 正在等待本地模型 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, client/js/vela/velaSurfaceController.js | no | A | Keep unless a future focused audit proves it is obsolete. |
...
| vela.surfaceStatusSetup | vela | Ready for a local message | 可以发送本地消息 | .tmp/a08-f1b/start/scripts/test-vela-surface-controller.js, .tmp/a08-f1b/start/scripts/test-vela-surface.js, client/js/vela/velaSurface.js, client/js/vela/velaSurfaceController.js | no | A | Keep unless a future focused audit proves it is obsolete. |
| vela.surfaceTranscriptIntro | vela | Start a local conversation with Vela. | 从本地模型开始与 Vela 对话。 | .tmp/a08-f1b/start/scripts/test-vela-surface.js, client/js/vela/velaSurface.js, client/js/vela/velaTranscriptView.js | no | A | Keep unless a future focused audit proves it is obsolete. |
